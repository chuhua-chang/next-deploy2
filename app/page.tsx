...
export default function Home() {
    ...
    <main className="p-6 max-w-5xl mx-auto">
      <div className="flex flex-col sm:flex-row items-start gap-8 mb-8">
        <div className="flex-1">
          ...
          <p className="mb-2"><b>Ph.D. in Neuroscience</b></p>
  ...
  <div className="flex-shrink-0 p-4 mb-4">
    ...
    <section className="mb-8">
      ...
      <p>
        I am an enthusiastic Neuroscience Ph.D. graduate with expertise in using stem cell-derived dopaminergic neurons and organoids to model Parkinson's Disease. I am driven by a deep curiosity about the complexities of the brain and seek postdoctoral opportunities to further investigate the molecular mechanisms underlying neurodegenerative diseases. My dissertation has been submitted, and my Ph.D. viva is expected in May 2025.
      </p>
   
      <p>Outside of lab, I exercise a lot! I am also actively learning web development. I have 3 cats at home that I absolutely adore! </p>
    </section>
  </main>
  );
}
